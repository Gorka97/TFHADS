...
urlpatterns = [
    ...
    url(r'^(?P<question_id>\d+)/results/correct$', app.views.quiz_results_correct, name='correct'),
    url(r'^(?P<question_id>\d+)/results/incorrect$', app.views.quiz_results_incorrect, name='incorrect'),
